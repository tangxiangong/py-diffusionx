...
pub fn levy_walk_simulate(
    ...
    let (times, positions) = levy_walk.simulate(duration, step_size)?;
...
pub fn levy_walk_raw_moment(
    ...
    let levy_walk = LevyWalk::new(alpha, velocity, start_position)?;
    let result = levy_walk.raw_moment(duration, order, particles, step_size)?;
    Ok(result)
}
...
pub fn levy_walk_central_moment(
    ...
    let levy_walk = LevyWalk::new(alpha, velocity, start_position)?;
    let result = levy_walk.central_moment(duration, order, particles, step_size)?;
    Ok(result)
}
...
pub fn levy_walk_fpt(
    ...
    let levy_walk = LevyWalk::new(alpha, velocity, start_position)?;
    let result = levy_walk.fpt(domain, max_duration, step_size)?;
    Ok(result)
}
