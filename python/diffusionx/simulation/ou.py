...
class Ou(StochasticProcess):
    ...
    def central_moment(
        ...
        if _order == 0:
            return 1.0
        if _order == 1:
            return 0.0  # First central moment is always 0 by definition.

        return _core.ou_central_moment(
            self.start_position,
            self.theta,
            self.mu,
            self.sigma,
    ...
    def fpt_raw_moment(
        ...
        return _core.ou_fpt_raw_moment(
            self.start_position,
            self.theta,
            self.mu,
            self.sigma,
    ...
    def fpt_central_moment(
        ...
        _a, _b = validate_domain(domain, process_name="Ou FPT central moment")
        _order = validate_order(order)
        _particles = validate_particles(particles)
        _step_size = validate_positive_float_param(step_size, "step_size")
        _max_duration = validate_positive_float_param(max_duration, "max_duration")
        ...
        return _core.ou_fpt_central_moment(
            self.start_position,
            self.theta,
            self.mu,
            self.sigma,
    ...
    def occupation_time_raw_moment(
        ...
        return _core.ou_occupation_time_raw_moment(
            self.start_position,
            self.theta,
            self.mu,
            self.sigma,
    ...
    def occupation_time_central_moment(
        ...
        _a, _b = validate_domain(domain, process_name="Ou Occupation central moment")
        _order = validate_order(order)
        _particles = validate_particles(particles)
        _duration = validate_positive_float_param(duration, "duration")
        _step_size = validate_positive_float_param(step_size, "step_size")
        ...
        return _core.ou_occupation_time_central_moment(
            self.start_position,
            self.theta,
            self.mu,
            self.sigma,
